...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="container mt-4">
        <h2>Data Guru</h2><br>
        <a class="btn btn-primary" href="kelola2.php" role="button">Tambah Data</a>
        <br><br>
        <table class="table table-striped">
            ...
            <tbody>
                ...
                while($guru = mysqli_fetch_array($query)) {
                    ...
                    echo "<td>
                    <a href='kelola2.php?edit=" . $guru['id_guru'] . "' class='btn btn-warning'>Edit</a>
                    <a href='proses2.php?hapus=" . $guru['id_guru'] . "' class='btn btn-danger'>Delete</a>
                          </td>";
                    echo "</tr>";
                }
                ?>
